  ...
  renderTitle = (details) => {
    return (
      <div className="person-container">
        <h1 className="person-name">Name: {details.name}</h1>
        <h3 className="person-age">Age: {details.age}</h3>
        <h3 className="person-gender">Eye Color: {details.eye_color}</h3>
        <h3 className="person-gender">Hair Color: {details.hair_color}</h3>
      </div>
    );
  };
